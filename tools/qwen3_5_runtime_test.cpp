...
int main() {
    ...
    config.layer_types = {"linear_attention", "sliding_attention", "full_attention", "linear_attention", "full_attention"};
    ...
    LinearStateSnapshot first; first.token_len = 8;
    LinearStateSnapshot second; second.token_len = 16;

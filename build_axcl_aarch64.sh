...
# 开始编译
cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=./install -DAXCL_DIR=${axcl_dir} -DCMAKE_TOOLCHAIN_FILE=../toolchains/aarch64-none-linux-gnu.toolchain.cmake -DBUILD_AX650=OFF -DBUILD_AXCL=ON ..
make -j16
make install

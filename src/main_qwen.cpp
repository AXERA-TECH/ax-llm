...
{
    LLaMaAttrType attr;
    attr.tokenizer_type = TKT_Qwen;
    attr.axmodel_num = 24;
    attr.template_filename_axmodel = "qwen1.5-0.5-bf16/qwen_l%d.axmodel";
    attr.filename_post_axmodel = "qwen1.5-0.5-bf16/qwen_post.axmodel";
    attr.filename_tokens_embed = "qwen.model.embed_tokens.weight.bfloat16.bin";
    attr.filename_tokenizer_model = "qwen.tiktoken";
    attr.tokens_embed_num = 151936;
    attr.tokens_embed_size = 1024;
    attr.kv_cache_size = 1024;

...
struct LLMAttrType {
    ...
    bool dynamic_load_enable = false;
    int dynamic_load_pool_size = 0;
...
public:
    ...
    // The non-const overload updates media_inputs when video-history isolation
    // remaps the current media turn's content index.
